...
<html lang = "en">
   ...
   <div class="jumbotron">
     <form class="form-horizontal" role="form" id="myform" method="post">    
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3">
             ...
             <br><br>
        <select class="form-control" name="onclick" onchange="location = this.options[this.selectedIndex].value;">

          <option value="index-1.php" selected>City Center (Sec 37) , Noida</option>
          <option value="index-2.php" >Pitampura</option>
     ...
     <img src="assets/Noida city centre.jpg">
     </div>
     </div>
     </div>
     <br><br>
